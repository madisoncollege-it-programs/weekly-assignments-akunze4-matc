...
parser.add_argument('-d', '--float', dest='Float', type=float,metavar="[a float]", help="Enter a float")
parser.add_argument('-s', '--string', dest='String', type=str,metavar="[a string]", help="Enter a string")
